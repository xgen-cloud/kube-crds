...
def additional_properties(data, skip=False):
    ...
    if isinstance(data, dict):
        if "properties" in data and not skip:
            preserve_unkown_fields = "x-kubernetes-preserve-unknown-fields" in data and data["x-kubernetes-preserve-unknown-fields"]
            if "additionalProperties" not in data and not preserve_unkown_fields:
